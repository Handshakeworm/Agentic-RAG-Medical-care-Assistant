...
| `image` | 532 | 4% | ✗ 仅留 caption + bbox(§3.1.1 末规则,content 字段 50% VLM 幻觉必丢) |
| `table` | 177 | 1% | ✓ 表格双粒度(整表 + 逐行) |
| `chart` | 74 | <1% | ✓ 图表(content 已是 markdown 数据表) |
| `equation_interline` | 54 | <1% | ✓ 行间公式(latex) |
