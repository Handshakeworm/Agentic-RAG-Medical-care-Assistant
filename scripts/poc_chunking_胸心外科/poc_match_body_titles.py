...
====================================================================
**只针对《胸心外科》POC** —— 字典构建依赖 poc_build_toc_dict.py。

输入:权威字典 91 条(2 篇 + 15 章 + 74 节),L1-L3 用于 title 匹配
正文范围:page_idx > max(toc_pages),即 pg 19 起(pg 19 篇内简表 / pg 20 空 / pg 21 第一章)
"""
...
def main() -> None:
    ...
    print(f"=== Missing (in L1-L3 dict but not found in body): {len(missing)} ===")
    ...
    print(f"  Missing in body:             {len(missing)}")
